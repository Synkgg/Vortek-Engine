	...
	, m_bShouldResize{ false }
{
	...
	{
		VORTEK_ASSERT( false && "Failed to create picking texture." );
		VORTEK_ERROR( "Failed to create picking texture." );
		// Should this throw??
	}
}
...
bool PickingTexture::Init( int width, int height )
{
	...
	if ( glCheckFramebufferStatus( GL_FRAMEBUFFER ) != GL_FRAMEBUFFER_COMPLETE )
	{
		...
		VORTEK_ERROR( "Failed to create a OpenGL frame buffer - {}", error );
