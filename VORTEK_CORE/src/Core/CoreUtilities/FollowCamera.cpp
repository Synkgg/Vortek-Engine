...
namespace VORTEK_CORE {
    ...
    FollowCamera::FollowCamera(VORTEK_RENDERING::Camera2D& camera, const ECS::Entity& entity, const FollowCamParams& params)
        : m_Camera{ camera }, m_Params{ params }, m_Entity{ entity }
    {
