...
#ifdef _WIN32
constexpr int VORTEK_KEY_LWIN = SDLK_LGUI;
constexpr int VORTEK_KEY_RWIN = SDLK_RGUI;
#else
constexpr int VORTEK_KEY_LGUI = SDLK_LGUI;
constexpr int VORTEK_KEY_RGUI = SDLK_RGUI;
#endif
