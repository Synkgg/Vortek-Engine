		...
		, m_JoystickHatValue{ VORTEK_HAT_CENTERED }
{
	...
	VORTEK_LOG( "Gamepad name: {}", m_sName );
	VORTEK_LOG( "Gamepad id: {}", m_InstanceID );
	VORTEK_LOG( "Gamepad num axes: {}", num_axis );
	VORTEK_LOG( "Gamepad num balls: {}", num_balls );
	VORTEK_LOG( "Gamepad num hats: {}", num_hats );
	VORTEK_LOG( "Gamepad num buttons: {}", num_buttons );
}
