...
class ToolManager
{
  public:
	...
	void Update( Vortek::Core::Canvas& canvas );
	 ...
	 */
	bool SetupTools( SceneObject* pSceneObject, Vortek::Rendering::Camera2D* pCamera );
	...
	std::vector<Vortek::Core::Events::EventDispatcher*> GetDispatchers();
