...
class SceneObject : public Vortek::Core::Scene
{
  public:
	SceneObject( const std::string& sceneName, Vortek::Core::EMapType eType = Vortek::Core::EMapType::Grid );
	 ...
	 */
	void CopyPlayerStartToRuntimeRegistry( Vortek::Core::ECS::Registry& runtimeRegistry );
	...
	inline Vortek::Core::ECS::Registry& GetRuntimeRegistry() { return m_RuntimeRegistry; }

  private:
	void OnEntityNameChanges( Vortek::Editor::Events::NameChangeEvent& nameChange );
  ...
  private:
	...
	Vortek::Core::ECS::Registry m_RuntimeRegistry;
