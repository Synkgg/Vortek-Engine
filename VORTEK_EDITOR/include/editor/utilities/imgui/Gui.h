...
class Gui
{
  public:
	 ...
	 *
	 * @param pWindow Pointer to the Vortek::Windowing::Window containing the SDL window and OpenGL context.
	 * @return true if initialization was successful, false if already initialized or if any step fails.
	 */
	static bool InitImGui( Vortek::Windowing::Window* pWindow );
	 ...
	 *
	 * @param pWindow Pointer to the Vortek::Windowing::Window, used for viewport context restoration.
	 */
	static void End( Vortek::Windowing::Window* pWindow );
