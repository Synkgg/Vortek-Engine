...
struct EditorState
{
	...
	bool Save( Vortek::Core::ProjectInfo& projectInfo );
	bool Load( Vortek::Core::ProjectInfo& projectInfo );
	bool ImportState( const std::string& sImportedStateFile, Vortek::Core::ProjectInfo& projectInfo );
	...
	static bool CreateEditorStateFile( Vortek::Core::ProjectInfo& projectInfo );
};
