...
inline void DrawComponentsUtil::DrawEntityComponentInfo( Vortek::Core::ECS::Entity& entity )
{
...
template <typename TComponent>
inline void DrawComponentsUtil::DrawComponentInfo( Vortek::Core::ECS::Entity& entity, TComponent& component )
{
	DrawImGuiComponent( entity, component );
}
