...
class Gui
{
  public:
	 ...
	 *
	 * @param pWindow Pointer to the VORTEK_WINDOWING::Window containing the SDL window and OpenGL context.
	 ...
	 *
	 * @param pWindow Pointer to the VORTEK_WINDOWING::Window, used for viewport context restoration.
	 */
