...
bool EditorState::Save( VORTEK_CORE::ProjectInfo& projectInfo )
{
	...
	{
		VORTEK_ERROR( "Failed to save editor state at path [{}]", optEditorConfigFolder->string() );
		return false;
	}
	...
	{
		VORTEK_ERROR( "Failed to save editor state to file [{}] - [{}]", editorStatePath.string(), ex.what() );
		return false;
	}
...
bool EditorState::Load( VORTEK_CORE::ProjectInfo& projectInfo )
{
	...
	{
		VORTEK_ERROR( "Failed to load editor state at path [{}]", editorStatePath.string() );
		return false;
	}
	...
	{
		VORTEK_ERROR( "Failed to open project file [{}]", editorStatePath.string() );
		return false;
	}
	...
	{
		VORTEK_ERROR( "Failed to load editor state: File: [{}] is not valid JSON. - {} - {}",
	...
	{
		VORTEK_ERROR( "Failed to load project: File [{}] - Expecting \"editor_state\" member in project file.",
					 editorStatePath.string() );
		return false;
	}
