...
struct EditorState
{
	...
	bool Save( VORTEK_CORE::ProjectInfo& projectInfo );
	bool Load( VORTEK_CORE::ProjectInfo& projectInfo );
	bool ImportState( const std::string& sImportedStateFile, VORTEK_CORE::ProjectInfo& projectInfo );
	...
	static bool CreateEditorStateFile( VORTEK_CORE::ProjectInfo& projectInfo );
};
