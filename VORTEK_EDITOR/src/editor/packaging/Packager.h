...
struct PackageData
{
	std::unique_ptr<VORTEK_CORE::ProjectInfo> pProjectInfo{ nullptr };
	std::unique_ptr<VORTEK_CORE::GameConfig> pGameConfig{ nullptr };
...
{
  public:
	Packager( std::unique_ptr<PackageData> pData, std::shared_ptr<VORTEK_UTIL::ThreadPool> pThreadPool );
	~Packager();
