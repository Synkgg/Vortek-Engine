...
struct SceneRuntimeData
{
	...
	VORTEK_CORE::Canvas canvas;
};

class SceneObject : public VORTEK_CORE::Scene
{
  public:
	SceneObject( const std::string& sceneName, VORTEK_CORE::EMapType eType = VORTEK_CORE::EMapType::Grid );
	 ...
	 */
	void CopyPlayerStartToRuntimeRegistry( VORTEK_CORE::ECS::Registry& runtimeRegistry );
  ...
  private:
	void OnEntityNameChanges( VORTEK_EDITOR::Events::NameChangeEvent& nameChange );
